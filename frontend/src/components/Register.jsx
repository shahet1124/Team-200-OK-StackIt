...
export default function AMURegisterPage() {
   ...
   const handleButtonClick = () => {
      ...
      // Log individual form values to console
         ...
         >
            <div className="w-full max-w-md">
               ...
               <AnimatedDiv delay={900} className="grid grid-cols-2 gap-4">
                  <button className="flex items-center justify-center gap-3 px-4 py-3 bg-gray-800/50 hover:bg-gray-700/50 text-white rounded-xl border border-gray-700/50 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg hover:shadow-gray-700/25 active:scale-95"
                     style={{ backdropFilter: 'blur(8px)' }}>
